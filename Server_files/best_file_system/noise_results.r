...
for (method in method_vec){
    ...
    for (i in 1:length(measures)){
        results <- rbind(results,
                         ...
                         measures[i], as.numeric(str_replace(method, "res_nmtf_", "")), averages[1]))
    }
}
...
col_names <- c("Noise level","CSR", "Relevance","Recovery", "F score", "BiS")
#produce tables
