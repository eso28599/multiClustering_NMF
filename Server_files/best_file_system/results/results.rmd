...
if(phi_constant){
        ...
        combined_tabs <- combine_tables(tables, path_to_save_table, measures, x_title, subhead)
}
...
res_table <- all_table2(results_nmtf, measure_labels, path_to_save,
                 n_repeats, col_names, subhead, x_title, feat = "Factor")
```
