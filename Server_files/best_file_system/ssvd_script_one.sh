...
#PBS -q medium
#PBS -t 1-10
#PBS -o ssvd_data/logs/test_job.out
#PBS -e ssvd_data/logs/test_job.err

export R_LIBS="/home/clustor2/ma/e/eso18/R/x86_64-pc-linux-gnu-library/4.3"
export sim_folder_name=ssvd_data
...
#generate data
Rscript --vanilla ssvd_data_gen.r  ${sim_folder_name} $I

#now analyse in R
Rscript --vanilla methods_r.r  ${sim_folder_name} $I

#analyse in python
#python3 ssvd_methods_p.py ${sim_folder_name} $I
