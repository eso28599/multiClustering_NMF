...
#PBS -q medium
#PBS -t 1-10
#PBS -o ssvd2b_data/logs/test_job.out
#PBS -e ssvd2b_data/logs/test_job.err

export R_LIBS="/home/clustor2/ma/e/eso18/R/x86_64-pc-linux-gnu-library/4.3"
export sim_folder_name=ssvd2b_data
...
#generate data
Rscript --vanilla ssvd2b_data_gen.r  ${sim_folder_name} $I
