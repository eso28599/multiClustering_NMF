...
results[["Method"]] <- ifelse(results[["Method"]] == "res_nmtf_2",
                    ...
                    "3", ifelse(results[["Method"]] == "res_nmtf_4", "4", "5")))
...
path_to_save <- paste0(path_to_sim_folder, "/increasing_bicl_plot.pdf")
...
col_names <- c("No. of biclusters","CSR", "Relevance","Recovery", "F score", "BiS")
#produce tables
