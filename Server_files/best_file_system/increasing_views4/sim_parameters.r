...
row_start <- list(c(1, 76, 101, 151), c(1, 76, 101, 151),
                 c(1, 76, 101, 151), c(1, 76, 101, 151))
row_end <- list(c(75, 150, 175, 200), c(75, 150, 175, 200),
                 c(75, 150, 175, 200), c(75, 150, 175, 200))
#100, 50,250 features respectively
col_cl_dims <- c(100, 50, 250, 150)
col_start <- list(c(1, 31, 61, 81), c(1, 11, 31, 41),
                     c(1, 101, 126, 151), c(1, 41, 66, 91))
col_end <- list(c(30, 60, 80, 100), c(10, 30, 40, 50),
                         c(100, 125, 150, 250), c(40, 65, 90, 150))
